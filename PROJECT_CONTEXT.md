...
V4 已实现词汇专项“完成每日 20 词后继续学习”的机制。听力、阅读、翻译、写作仍然是“敬请期待”。后续开发须由用户明确提出，不自行开始 V5。
...
- AI、我的及其余四项专项继续占位。没有数据库、真实登录、真实 AI API、真实 CET-6 词库。
...
重点验收：每日 20→额外 10→再额外 20，仍保持每日 20/20、额外累计 30；刷新恢复、收藏、XP 去重、跨日、375/390/430px 与桌面布局，以及原每日关卡回归。
